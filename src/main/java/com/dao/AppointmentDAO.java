...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment ap)
	{
		...
		try {
			String sql="insert into appointment(user_id,fullname,gender,age,appoindate,appointype,phno,diseases,doctor_id,referralcenter,fulladdress,status) values(?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			ps.setString(6, ap.getAppointype());
			ps.setString(7, ap.getPhno());
			ps.setString(8, ap.getDiseases());
			ps.setInt(9, ap.getDoctorId());
			ps.setString(10, ap.getReferralcenter());
			ps.setString(11, ap.getFulladdress());
	...
	public List<Appointment> getAllAppointmentByLoginUser(int userId){
		...
		try {
			...
			while (rs.next()) {
				...
				ap.setReferralcenter(rs.getString(10));
				ap.setFulladdress(rs.getString(11));
	...
	public List<Appointment> getAllAppointmentByDoctorLogin(int doctorId) {
		...
		try {
			...
			while (rs.next()) {
				...
				ap.setAge(rs.getString(5));
				ap.setAppoindate(rs.getString(6));
				ap.setAppointype(rs.getString(7));
